...
from JannatMusic import BOT_USERNAME, app, jannatdb, pytgcalls
from JannatMusic.Helpers import _clear_, admin_check, buttons, close_key, gen_thumb
...
async def skip_str(_, message: Message):
    try:
        ...
        pass
    get = jannatdb.get(message.chat.id)
    if not get:
        try:
