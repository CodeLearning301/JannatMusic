...
logging.basicConfig(
    ...
    datefmt="%d-%b-%y %H:%M:%S",
    handlers=[logging.FileHandler("jannatlogs.txt"), logging.StreamHandler()],
    level=logging.INFO,
)
logging.getLogger("pyrogram").setLevel(logging.ERROR)
logging.getLogger("pytgcalls").setLevel(logging.ERROR)
LOGGER = logging.getLogger("JannatMusic")
...
async def jannat_startup():
    ...
    global BOT_ID, BOT_NAME, BOT_USERNAME, BOT_MENTION, jannatdb
    ...
    try:
        await app2.join_chat("jannatupdate")
        await app2.join_chat("jannatupdate")
    except:
        pass
